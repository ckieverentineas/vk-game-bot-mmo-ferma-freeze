...
export async function Printer_Builder_Config(name: string, lvl_be: number, user: User, id_builder?: number) {
    ...
    if (builder_configs[i].input) {
        event_logger += `\n\n📈 Прибыль: `
        event_logger += `${builder_configs[i].input?.gold != undefined ? `\n${icotransl_list[builder_configs[i].input!.gold.name].smile} ${icotransl_list[builder_configs[i].input!.gold.name].name}: ${(builder_configs[i].input!.gold.income*((lvl)**builder_configs[i].input!.gold.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.energy != undefined ? `\n${icotransl_list[builder_configs[i].input!.energy.name].smile} ${icotransl_list[builder_configs[i].input!.energy.name].name}: ${(builder_configs[i].input!.energy.income*((lvl)**builder_configs[i].input!.energy.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.metal != undefined ? `\n${icotransl_list[builder_configs[i].input!.metal.name].smile} ${icotransl_list[builder_configs[i].input!.metal.name].name}: ${(builder_configs[i].input!.metal.income*((lvl)**builder_configs[i].input!.metal.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.crystal != undefined ? `\n${icotransl_list[builder_configs[i].input!.crystal.name].smile} ${icotransl_list[builder_configs[i].input!.crystal.name].name}: ${(builder_configs[i].input!.crystal.income*((lvl)**builder_configs[i].input!.crystal.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.crystal_dirt != undefined ? `\n${icotransl_list[builder_configs[i].input!.crystal_dirt.name].smile} ${icotransl_list[builder_configs[i].input!.crystal_dirt.name].name}: ${(builder_configs[i].input!.crystal_dirt.income*((lvl)**builder_configs[i].input!.crystal_dirt.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.artefact != undefined ? `\n${icotransl_list[builder_configs[i].input!.artefact.name].smile} ${icotransl_list[builder_configs[i].input!.artefact.name].name}: ${(builder_configs[i].input!.artefact.income*((lvl)**builder_configs[i].input!.artefact.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.golden != undefined ? `\n${icotransl_list[builder_configs[i].input!.golden.name].smile} ${icotransl_list[builder_configs[i].input!.golden.name].name}: ${(builder_configs[i].input!.golden.income*((lvl)**builder_configs[i].input!.golden.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.iron != undefined ? `\n${icotransl_list[builder_configs[i].input!.iron.name].smile} ${icotransl_list[builder_configs[i].input!.iron.name].name}: ${(builder_configs[i].input!.iron.income*((lvl)**builder_configs[i].input!.iron.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.uranium != undefined ? `\n${icotransl_list[builder_configs[i].input!.uranium.name].smile} ${icotransl_list[builder_configs[i].input!.uranium.name].name}: ${(builder_configs[i].input!.uranium.income*((lvl)**builder_configs[i].input!.uranium.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.oil != undefined ? `\n${icotransl_list[builder_configs[i].input!.oil.name].smile} ${icotransl_list[builder_configs[i].input!.oil.name].name}: ${(builder_configs[i].input!.oil.income*((lvl)**builder_configs[i].input!.oil.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.gas != undefined ? `\n${icotransl_list[builder_configs[i].input!.gas.name].smile} ${icotransl_list[builder_configs[i].input!.gas.name].name}: ${(builder_configs[i].input!.gas.income*((lvl)**builder_configs[i].input!.gas.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.coal != undefined ? `\n${icotransl_list[builder_configs[i].input!.coal.name].smile} ${icotransl_list[builder_configs[i].input!.coal.name].name}: ${(builder_configs[i].input!.coal.income*((lvl)**builder_configs[i].input!.coal.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.builder_block != undefined ? `\n${icotransl_list[builder_configs[i].input!.builder_block.name].smile} ${icotransl_list[builder_configs[i].input!.builder_block.name].name}: ${(builder_configs[i].input!.builder_block.income*((lvl)**builder_configs[i].input!.builder_block.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].input?.research != undefined ? `\n${icotransl_list[builder_configs[i].input!.research.name].smile} ${icotransl_list[builder_configs[i].input!.research.name].name}: ${(builder_configs[i].input!.research.income*((lvl)**builder_configs[i].input!.research.koef)).toFixed(2)}` : ""}`
    }
    ...
    if (builder_configs[i].output) {
        event_logger += `\n\n📉 Потребление: `
        event_logger += `${builder_configs[i].output?.gold != undefined ? `\n${icotransl_list[builder_configs[i].output!.gold.name].smile} ${icotransl_list[builder_configs[i].output!.gold.name].name}: ${(builder_configs[i].output!.gold.outcome*((lvl)**builder_configs[i].output!.gold.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.energy != undefined ? `\n${icotransl_list[builder_configs[i].output!.energy.name].smile} ${icotransl_list[builder_configs[i].output!.energy.name].name}: ${(builder_configs[i].output!.energy.outcome*((lvl)**builder_configs[i].output!.energy.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.metal != undefined ? `\n${icotransl_list[builder_configs[i].output!.metal.name].smile} ${icotransl_list[builder_configs[i].output!.metal.name].name}: ${(builder_configs[i].output!.metal.outcome*((lvl)**builder_configs[i].output!.metal.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.crystal != undefined ? `\n${icotransl_list[builder_configs[i].output!.crystal.name].smile} ${icotransl_list[builder_configs[i].output!.crystal.name].name}: ${(builder_configs[i].output!.crystal.outcome*((lvl)**builder_configs[i].output!.crystal.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.crystal_dirt != undefined ? `\n${icotransl_list[builder_configs[i].output!.crystal_dirt.name].smile} ${icotransl_list[builder_configs[i].output!.crystal_dirt.name].name}: ${(builder_configs[i].output!.crystal_dirt.outcome*((lvl)**builder_configs[i].output!.crystal_dirt.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.artefact != undefined ? `\n${icotransl_list[builder_configs[i].output!.artefact.name].smile} ${icotransl_list[builder_configs[i].output!.artefact.name].name}: ${(builder_configs[i].output!.artefact.outcome*((lvl)**builder_configs[i].output!.artefact.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.golden != undefined ? `\n${icotransl_list[builder_configs[i].output!.golden.name].smile} ${icotransl_list[builder_configs[i].output!.golden.name].name}: ${(builder_configs[i].output!.golden.outcome*((lvl)**builder_configs[i].output!.golden.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.iron != undefined ? `\n${icotransl_list[builder_configs[i].output!.iron.name].smile} ${icotransl_list[builder_configs[i].output!.iron.name].name}: ${(builder_configs[i].output!.iron.outcome*((lvl)**builder_configs[i].output!.iron.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.uranium != undefined ? `\n${icotransl_list[builder_configs[i].output!.uranium.name].smile} ${icotransl_list[builder_configs[i].output!.uranium.name].name}: ${(builder_configs[i].output!.uranium.outcome*((lvl)**builder_configs[i].output!.uranium.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.oil != undefined ? `\n${icotransl_list[builder_configs[i].output!.oil.name].smile} ${icotransl_list[builder_configs[i].output!.oil.name].name}: ${(builder_configs[i].output!.oil.outcome*((lvl)**builder_configs[i].output!.oil.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.gas != undefined ? `\n${icotransl_list[builder_configs[i].output!.gas.name].smile} ${icotransl_list[builder_configs[i].output!.gas.name].name}: ${(builder_configs[i].output!.gas.outcome*((lvl)**builder_configs[i].output!.gas.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.coal != undefined ? `\n${icotransl_list[builder_configs[i].output!.coal.name].smile} ${icotransl_list[builder_configs[i].output!.coal.name].name}: ${(builder_configs[i].output!.coal.outcome*((lvl)**builder_configs[i].output!.coal.koef)).toFixed(2)}` : ""}`
        event_logger += `${builder_configs[i].output?.builder_block != undefined ? `\n${icotransl_list[builder_configs[i].output!.builder_block.name].smile} ${icotransl_list[builder_configs[i].output!.builder_block.name].name}: ${(builder_configs[i].output!.builder_block.outcome*((lvl)**builder_configs[i].output!.builder_block.koef)).toFixed(2)}` : ""}`
    }
